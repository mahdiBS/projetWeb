          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Modifier Solde : </h5>
...
if (isset($_POST['IDsolde'])){
  $soldeC=new SoldeC();
    $result=$soldeC->recuperersolde($_POST['IDsolde']);
...
<form method="POST"  name ="f1" action="modifiersoldefonction.php" >
  <div class="card-body">
...
<select  class="form-control"type="number" name="produit" required >
  <option ><?PHP echo $produit ?></option>
...
<tr>
<td><label>Prix DT</label></td>
<td><input class="form-control"type="number" name="nov" value="<?PHP echo $nov ?>" required></td>
</tr>
<tr>

  <tr>
<td><label>Date debut</label></td>
<td><input class="form-control"type="Date" name="datedebut" value="<?PHP echo $datedebut ?>" required></td>
</tr>
<tr>

  <tr>
<td><label>Date fin</label></td>
<td><input class="form-control"type="Date" name="datefin" value="<?PHP echo $datefin ?>" required></td>
</tr>
<tr>
