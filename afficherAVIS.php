...
?>
                      ...
                      <div class="form-group">
                        <label>Id Produit</label>
                          <select name="id_prod" class="form-control">
                            ...
                            ?>
                            <option value="<?PHP echo $row['id_prod']; ?>"><?PHP echo $row['id_prod']; ?>
                            </option>
                            <?PHP } ?>
                          </select>
                      </div>
              ...
              <div class="card-footer">
                <form name="get" action="afficherCommentaire.php">
                <input type="submit" name="afficher" class="btn btn-fill btn-primary" onclick="show()">
