...
<ul>
  ...
  <li><a  href="#">Utilisateur</a>
   ...
   <li><a  href="#">Panier</a>
    ...
    <ul>
      <li><a href="../../Eve/ajouterEvenement.html">Ajouter un évenement</a></li>
      <li><a href="../../Eve/modifierEvenement.html">Modifier un évenement</a></li>
      <li><a href="../../Eve/supprimerEvenement.html">Supprimer un évenement</a></li>
      <li><a href="../../Eve/afficherEvenement.html">Afficher les évenements </a></li>
      <li><a href="#">Soldes</a>
        <ul>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Supprimer solde</h5>
              </div>
              <div class="card-body">
                <form name="fsup" method="POST" action="supprimerSOL.php">
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group" >
                        <label>ID Evenement: </label>
                         <select  name="IDsolde" id="idsolde" required class="btn-outline-neutral" >
            <option ><?php echo $options;?></option>
                ...
                <input  type="button" class="btn btn-fill btn-primary" onclick="validesup()" value="VALIDER" >
