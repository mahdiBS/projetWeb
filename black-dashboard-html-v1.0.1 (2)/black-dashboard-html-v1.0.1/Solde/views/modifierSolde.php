...
<!-- ds-->
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Modiier Solde</h5>
              </div>
              <div class="card-body">
                <form name="f" method="POST" action="modifierS.php">
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group" >
                        ...
                        <select  name="IDsolde" id="idsolde"  class="btn-outline-neutral" required>
  ...
  <script src="../../assets/demo/demo.js"></script>
    <script type="text/javascript" src="../../assets/js/Evenement/solde.js"></script>
