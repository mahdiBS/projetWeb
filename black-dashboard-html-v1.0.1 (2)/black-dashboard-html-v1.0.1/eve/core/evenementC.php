...
function afficherevenements(){
	...
	function modifierevenement($evenement,$IDevenement){
		$sql="UPDATE evenement SET IDevenement=:IDevenementn, Nomevenement=:Nomevenement,PRIXevenement=:PRIXevenement,ADRESSEevenement=:ADRESSEevenement,Nombresplaces=:Nombresplaces,Date=:date,Heure=:heure WHERE IDevenement=:IDevenement";
...
try{		
        ...
        $heure=$evenement->getHeureevenement();
