          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Modifier evenement : </h5>
...
if (isset($_POST['IDevenement'])){
    ...
    $result=$evenementC->recupererevenement($_POST['IDevenement']);
	foreach($result as $row){
		$id=$row['IDevenement'];
		$adresse=$row['ADRESSEevenement'];
		$heure=$row['Heure'];
		$nom=$row['Nomevenement'];
		$prix=$row['PRIXevenement'];
		$nbr=$row['Nombresplaces'];
		$date=$row['Date'];
?>
...
<table heigth="600" id="t1">

<tr>
	
<td><label>ID</label></td>
<td><input class="form-control" type="number" name="id" value="<?PHP echo $id ?>"readonly></td>
...
<td><input class="form-control"type="text" name="nom" value="<?PHP echo $nom ?>" pattern="[A-Za-z]+"></td>
</tr>
...
<tr>
<td><label>nbr_places</label></td>
<td><input class="form-control" type="number" name="nbr" value="<?PHP echo $nbr ?>" min="0" ></td>
</tr>
<tr>
<td><label>prix</label></td>
<td><input class="form-control" type="number" name="prix" value="<?PHP echo $prix ?>" min="0" ></td>
</tr>
<tr>
<td><label>adrresse</label></td>
<td><input class="form-control" type="text" name="adresse" value="<?PHP echo $adresse ?>" pattern="[A-Za-z0-9]+"></td>
</tr>
<tr>
<td><label>heure</label></td>
<td><input class="form-control" type="time" name="heure" value="<?PHP echo $heure ?>"></td>
</tr>
<tr>
<td></td>
<td><center><input type="submit" name="modifier" value="modifier" class="btn btn-fill btn-primary"></center></td>
</tr>
</div>
            </div>
          </div>
...
if (isset($_POST['modifier'])){
	$evenement=new evenement($_POST['id'],$_POST['nom'],$_POST['prix'],$_POST['adresse'],$_POST['nbr'],$_POST['date'],$_POST['heure']);
$evenementC=new EvenementC();
