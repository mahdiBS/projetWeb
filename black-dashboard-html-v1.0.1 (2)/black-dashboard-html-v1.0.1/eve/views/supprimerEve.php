...
<head>
  ...
  <script src="../assets/js/Eve/jquery.min.js"></script>

<script type="text/javascript" src="../assets/js/Eve/evenement.js"></script>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Supprimer Evenement:</h5>
              </div>
              <div class="card-body">
                <form name="fsup" method="POST"  action="supprimerevenement.php">
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group" >
                        <label>ID Evenement: </label>
                         <select  name="IDevenement" id="ID evenement" required class="btn-outline-neutral" >
            ...
            <option  ><?php echo $options;?></option>
              ...
              <div class="card-footer">
                <button type="button" class="btn btn-fill btn-primary" onclick="validesup()">Valider</button>
                <div id="toast"></div>
              </div>
            </div>
          </div>
