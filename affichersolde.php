...
$sort=new Sort();
$result=$sort->sortsolde();

$soldeC=new soldeC();
$listesoldes=$soldeC->affichersolds();
...
<table border="4" width="900" height= "90px" align="center"  >

<tr>
<td><center><h4>ID</h4></center></td>
<td><center><h4>Produit</h4></center></td>
<td><center><h4>Prix</h4></center></td>
<td><center><h4>Date debut</h4></center></td>
<td><center><h4>Date fin</h4></center></td>
<td><center><h4>Description</h4></center></td>
                ...
                <tr>
                    <td><center><h5><?php echo $row[0];?></h5></center></td>
                    <td><center><h5><?php echo $row[1];?></h5></center></td>
                    <td><center><h5><?php echo $row[2];?></h5></center></td>

                    <td><center><h5><?php echo $row[3];?></h5></center></td>
                    <td><center><h5><?php echo $row[4];?></h5></center></td>
                    <td><center><h5><?php echo $row[5];?></h5></center></td>
...
<div id="sort">
<button type="submit" name="ASC"  class="btn btn-fill btn-primary">croissante  &nbsp;&nbsp; &#8593; </button>
            <button type="submit" name="DESC"  class="btn btn-fill btn-primary">decroissante  &nbsp;  &#8595;</button>
</div>
</form>
      <div id="navbar">
...
<footer class="footer">
  ...
  <script type="text/javascript" src="../assets/js/Produit/produit.js"></script>
