...
$listeCommentaires=$commentaire1C->afficherCommentaires();
//echo $_GET['id'];
//var_dump($listeCommentaires->fetchAll());
?>
      <div class="content">
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Afficher les commentaires</h5>
                <a href="afficherCommentaire.php">Retour à l'affichage</a>
                                          <div class="card-footer">
                <!-- <button type="submit" class="btn btn-fill btn-primary" onclick="show()">Afficher</button>-->
                <div id="toast"></div>
              </div>
              ...
              <form method="get">
                      ...
                      <tr>
                        <td>
                            <label>Nom: <?PHP echo $rec['nom'] ?></label>
                            <label>Prenom: <?PHP echo $rec['prenom'] ?></label>
                            <label>Identifiant client:<?PHP echo $rec['id'] ?></label> 
                            <label>Identifiant produit: <?PHP echo $rec['id_prod'] ?></label>
                            <label>Commentaire: <?PHP echo $rec['com'] ?></label>
                            <label>Date: <?PHP echo $rec['dat'] ?></label>
                        </td>
                        </tr>        
                        <tr>
                              ...
                              <input type="hidden" class="btn btn-fill btn-primary" value="<?PHP echo $rec['id_prod']; ?>" name="Identifiant_prod">
                              </form>
                              <!--<form>
                              <td><a class="btn btn-fill btn-primary" href="modifierReclamation.php?Identifiant=<?PHP// echo $rec['Identifiant']; ?>"> Modifier</a></td>
                              <td><a class="btn btn-fill btn-primary" href="envoyerMail.php"> Envoyer mail</a></td>
                              </form>-->   
                              <td><a class="btn btn-fill btn-primary" href="envoyerMail.php"> Envoyer mail</a></td>                    
                        </tr>
