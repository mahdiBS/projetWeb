...
<html>
<head>
<title>Grain de beauté | Evenement  </title>
...
<!--banner-->
	...
	<div class="container">
		<h1>Evenement</h1>
		<em></em>
		<h2><a href="index.html">Home</a><label>/</label>Evenement</h2>
	</div>
</div>	
			...
			<div class="contact">
				...
				<div class="col-md-6 contact-top">
					<h3>Participer à l'évenement?</h3>
					<form name="f" method="POST" action="views/participerevenement.php" >

	<div>					
<span>Evenement:</span>	
<select  name="IDevenement" id="IDevenement" required class="btn-outline-neutral" >
                          <p style="color: red;" id="nomm"></p>
            <option  ><?php echo $options;?></option>
						...
						<div>
							<span>Nom:</span>
						<input type="text"  name="noom" id="nom"required maxlength ="20">
				</div>
				<p style="color: red;" id="nomm"></p>
				...
				<div >
					<span>Prenom:</span>
					<input type="text"  name="preenom" id="prenom" required maxlength ="20">					
				</div>
				<p style="color: red;" id="prenomm"></p>


				<div  ><span>Numero:</span>
					<input type="text" placeholder="+216 ******" name="nuumero" id="numero" required minlength="8" maxlength="8">
					
				</div>
					
				<p style="color: red;" id="numeroo"></p>
		...
		<div class="map">
						<iframe src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;q=tunis%20ariana+(My%20Business%20Name)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed"></iframe>
					</div>
	</div>
