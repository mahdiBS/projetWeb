...
<head>
  ...
  <script type="text/javascript" src="../../assets/js/Eve/solde.js"></script>
...
<ul>
  ...
  <li><a  href="#">Utilisateur</a>
   ...
   <li><a  href="#">Panier</a>
    ...
    <ul>
      <li><a href="../../eve/views/ajouterEvenement.html">Ajouter un évenement</a></li>
      <li><a href="../../eve/views/modifierEve.php">Modifier un évenement</a></li>
      <li><a href="../../eve/views/supprimerEve.php">Supprimer un évenement</a></li>
      <li><a href="../../eve/views/afficherevenment.php">Afficher les évenements </a></li>
      <li><a href="#">Soldes</a>
        <ul>
          <li><a href="ajouterSolde.html">Ajouter les articles soldés</a></li>
          <li><a href="modifierSolde.php">Modifier les articles soldés</a></li>
          <li><a href="affichersolde.php">Afficher les articles soldés</a></li>
          <li><a href="supprimerSolde.php">Supprimer les articles soldés</a></li>
        </ul>
      </li>
    </ul>
  </li>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Ajouter Solde:</h5>
              </div>
              <div class="card-body">
                <form name="f" method="POST" action="ajoutSolde.php" >
                  <div class="row">   
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group" >
                        <label>ID Solde</label>
                        <input type="text" class="form-control" placeholder="Identifiant" name="idSolde" id="IdSolde" >
...
<div class="row"> 
                   <div class="col-md-4 pl-md-1">
                      <div class="form-group" >
                        <label> Produit en solde:</label>
                      
                        <select  class="form-control" placeholder="ID Produit" name="produit" id="Produit" required>
...
<div class="row">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Saisir pourcentage solde" name="pourcentageSolde" id="PourcentageSolde">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        ...
                        <input type="Date" class="form-control" placeholder="datefin" name="datefin" id="datefin" required>
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        ...
                        <textarea  class="form-control" placeholder="description" name="description" id="description"  maxlength="100" required></textarea>
                    ...
                    <input type="button" onclick="show()"  class="btn btn-fill btn-primary"  value="Valider">
                     <div id="toast"></div>
                  </form>
