...
$listeEmployes1=$employe1C->graphe();
 ...
 <link href="../assets/css/notification.css" rel="stylesheet" />
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ['Nomevenement', 'Nombresplaces'],  
                          <?php  
                          while($row = mysqli_fetch_array($listeEmployes1))  
                          {  
                               echo "['".$row["Nomevenement"]."', ".$row["Nombresplaces"]."],"; 
          ...
          <div class="navbar-wrapper">
            <div class="navbar-toggle d-inline">
              <button type="button" class="navbar-toggler">
                <div class="navbar-toggler-bar bar1"></div>
                <div class="navbar-toggler-bar bar2"></div>
                <div class="navbar-toggler-bar bar3"></div>
              </button>
            </div>
  ...
  <li><a href="#">Utilisateur</a>
   ...
   <li><a href="#">Produits</a>
    <ul>
      ...
      <li><a href="#">Afficher les  produits </a></li>
      <li><a href="#">Catègories</a>
        <ul>
          <li><a href="#">Ajouter une Catègorie</a></li>
          <li><a href="#">Modifier une Catègorie</a></li>
          <li><a href="#">Afficher les Catègories</a></li>
          <li><a href="#">Supprimer une Catègorie</a></li>
        </ul>
      </li>
    </ul>
  </li>
   <li><a href="#">Commandes</a>
    <ul>
      ...
      <li><a href="#">Modifier une commande</a></li>
      <li><a href="#">Supprimer une commande</a></li>
      ...
      <li><a href="#">Facturation</a>
        <ul>
          ...
          <li><a href="#">Afficher les factures</a></li>
...
<!-- ds-->
          ...
          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navigation" aria-expanded="false" aria-label="Toggle navigation">
            <div class="navbar-toggler-bar navbar-kebab"></div>
            <div class="navbar-toggler-bar navbar-kebab"></div>
            <div class="navbar-toggler-bar navbar-kebab"></div>
          </button>
            ...
            <ul class="navbar-nav ml-auto">
              <li class="search-bar input-group">
                <button class="btn btn-link" id="search-button" data-toggle="modal" data-target="#searchModal"><i class="tim-icons icon-zoom-split"></i>
                  <div class="d-lg-none d-md-block">Search</div>
                </button>
              </li>
...
<table border="3" width="900" height= "90px" align="center"  >
...
<?PHP
foreach($listeEmployes as   $key=> $row){
	?>
	<tr>
	<td><center><h5><?PHP echo $row['IDevenement']; ?></h5></center></td>
	<td><center><h5><?PHP echo $row['Nomevenement']; ?></h5></center></td>
	<td><h5><?PHP echo $row['PRIXevenement']; ?></h5></td>
	<td><h5><?PHP echo $row['ADRESSEevenement']; ?></h5></td>
	<td><h5><?PHP echo $row['Nombresplaces']; ?></h5></td>
	<td><h5><?PHP echo $row['Date']; ?></h5></td>

	<td><h5><?PHP echo $row['Heure']; ?></h5></td>
...
var my_date = "<?PHP echo $row['Date']; ?>";
my_date = my_date.replace(/-/g, "/"); 
var d= new Date(my_date);

  

     var my_Hours = "<?PHP echo $row['Heure'] ?>";
 

 
var res = parseFloat(my_Hours.substring(0,2));
var res1 =parseFloat( my_Hours.substring(3,5));
...
var diferance=((((date.getMonth())*43800)+(date.getDay()*1440)+date.getMinutes()+(date.getHours()*60 ) )-((d.getMonth()*43800)+(d.getDay()*1440)+res1+(res*60 ) ));




  
  var ms=9,s=60,mn=Math.abs( Math.trunc(diferance%60)),h=Math.abs(Math.trunc(diferance/60));
...
<div class="chronometre">
  <div class="tim">
  	...
  	<span >0 ms</span></h3>
  	 ...
  	 <script > setInterval(update_chrono,100);</script>
           ...
           <div id="graphe">
                ...
                <div id="char" >Graphe de nombre des places par nom </div>  
        ...
        <li class="adjustments-line">
          <a href="javascript:void(0)" class="switch-trigger background-color">
            <div class="badge-colors text-center">
              <div class="badge filter badge-primary active" data-color="primary"></div>
              <div class="badge filter badge-info" data-color="blue"></div>
              <div class="badge filter badge-success" data-color="green"></div>
            </div>
            <div class="clearfix"></div>
          </a>
        </li>
        <li class="adjustments-line text-center color-change">
          <div class="color-label">LIGHT MODE</div>
          <div class="badge light-badge mr-2"></div>
          <div class="badge dark-badge ml-2"></div>
          <div class="color-label">DARK MODE</div>
        </li>
  ...
  <script>
    $(document).ready(function() {
      $().ready(function() {
        ...
        $('.fixed-plugin .background-color div').click(function() {
