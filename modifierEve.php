...
<!-- ds-->
        ...
        <div class="row">
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-body">
                <form name="f" method="POST" action="modifierevenement.php">
                  <div class="row">
                    ...
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group" >
                        ...
                        <select  name="IDevenement" id="ID evenement"  class="btn-outline-neutral" required>
  ...
  <script src="../assets/demo/demo.js"></script>
    <script type="text/javascript" src="../assets/js/Evenement/evenement.js"></script>
