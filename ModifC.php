...
<ul>
  ...
  <li><a href="#">Utilisateur</a>
   ...
   <li><a href="#">Produits</a>
    <ul>
      <li><a href="./AjouterProduit1.php">Ajouter un produit</a></li>
      <li><a href="./modif.php">Modifier un produit</a></li>
      <li><a href="./sup.php">Supprimer un produit</a></li>
      ...
      <li><a href="#">Catègories</a>
         <ul>
          ...
          <li><a href="./ModifC.php">Modifier une Catègorie</a></li>
          <li><a href="./AfficherCategorie.php">Afficher les Catègories</a></li>
          <li><a href="./SuppC.php">Supprimer une Catègorie</a></li>
        </ul>
      </li>
    </ul>
  </li>
...
foreach($listeCategories as $row){
	?>
	<tr>
	<td><?PHP echo $row['IdCategories']; ?></td>
	...
	<input type="hidden" value="<?PHP echo $row['IdCategories']; ?>" name="IdCategories">
	</form>
	</td>
	<td><a href="ModifierCategories.php?IdCategories=<?PHP echo $row['IdCategories']; ?>">
	Modifier</a></td>
	</tr>
	<?PHP
}
